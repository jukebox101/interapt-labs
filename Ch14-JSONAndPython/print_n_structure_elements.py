...
# The deal with using this as a module is that
# YOU ONLY IMPORT print_first_n_values (OR print_first_n_values_IF_ELIF)
# BECAUSE THE USER (CLIENT) OF THIS MODULE NEED NEVER CALL ANY OF
# THE FUNCTIONS FOR A PARTICULAR STRUCTURE TYPE
